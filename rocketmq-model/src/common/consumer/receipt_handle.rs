...
/// # Example
/// ```
/// use rocketmq_model::common::consumer::receipt_handle::ReceiptHandle;
///
...
impl ReceiptHandle {
    ...
    pub fn is_expired(&self) -> bool {
        self.next_visible_time <= current_millis() as i64
    }
    ...
    /// ```
    /// use rocketmq_model::common::consumer::receipt_handle::ReceiptHandle;
    /// use rocketmq_model::common::consumer::receipt_handle::RETRY_TOPIC;
    ///
    /// let handle = ReceiptHandle::builder()
    ///     .start_offset(100)
    ///     .retrieve_time(1000000)
    ...
    /// ```
    /// use rocketmq_model::common::consumer::receipt_handle::ReceiptHandle;
    /// use rocketmq_model::common::consumer::receipt_handle::NORMAL_TOPIC;
    ///
    /// let handle = ReceiptHandle::builder()
    ///     .start_offset(100)
    ///     .retrieve_time(1000000)
