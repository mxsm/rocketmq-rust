...
///
/// ```
/// use rocketmq_model::utils::crc32_utils::crc32_range;
///
/// let data = b"Hello, World!";
...
///
/// ```
/// use rocketmq_model::utils::crc32_utils::crc32_bytebuffer;
///
...
///
/// ```
/// use rocketmq_model::utils::crc32_utils::crc32_bytebuffers;
///
