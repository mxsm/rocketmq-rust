                    ...
                    <div className="border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm">
                        <div className="min-w-full">
                                    ...
                                    {nameServers.map((ns) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 font-mono text-sm text-gray-700 dark:text-gray-300 flex items-center">
                                                <Server
                                                    className={`w-4 h-4 mr-3 ${ns === selectedNameServer ? 'text-blue-500' : 'text-gray-400 dark:text-gray-500'}`}/>
                                                {ns}
                                            </div>
                                            ...
                                            <div className="w-32 flex justify-center">
                                                {ns === selectedNameServer ? (
                                                    <span
                                                        className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400 border border-green-200 dark:border-green-800 shadow-sm">
                            <motion.span
                            ...
                            Active
                                                    ...
                                                    <span
                                                        className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700">
                            Standby
                          </span>
                                                )}
                                            </div>
