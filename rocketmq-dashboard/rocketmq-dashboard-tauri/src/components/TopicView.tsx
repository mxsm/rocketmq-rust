            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {mockBrokerDatas.map((broker, i) => (
                  <div key={i} className="bg-white dark:bg-gray-900 p-5 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-base font-bold text-gray-900 dark:text-white">{broker.broker}</span>
                      <span className="text-xs bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 px-2.5 py-1 rounded-full font-medium border border-gray-200 dark:border-gray-700">
                        {broker.addrs.length} Addrs
                      </span>
                    </div>
                    <div className="space-y-2">
                       {broker.addrs.map((addr, j) => (
                         <div key={j} className="flex items-center justify-between text-xs bg-gray-50 dark:bg-gray-800/50 p-3 rounded-lg border border-gray-100 dark:border-gray-800/50 font-mono">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {mockQueueDatas.map((queue, i) => (
                  <div key={i} className="bg-white dark:bg-gray-900 p-5 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                    <div className="flex items-center space-x-3 mb-5">
                       <div className="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-900/30">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-5 flex-1">
                      <div className="bg-gray-50 dark:bg-gray-800/50 p-3 rounded-xl border border-gray-100 dark:border-gray-800 text-center group hover:border-blue-200 dark:hover:border-blue-800 transition-colors">
                         <div className="text-[10px] uppercase text-gray-400 dark:text-gray-500 font-bold mb-1 tracking-wider">Read</div>
                         <div className="text-xl font-mono font-bold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{queue.readQueueNums}</div>
                      </div>
                      <div className="bg-gray-50 dark:bg-gray-800/50 p-3 rounded-xl border border-gray-100 dark:border-gray-800 text-center group hover:border-blue-200 dark:hover:border-blue-800 transition-colors">
                         <div className="text-[10px] uppercase text-gray-400 dark:text-gray-500 font-bold mb-1 tracking-wider">Write</div>
                         <div className="text-xl font-mono font-bold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{queue.writeQueueNums}</div>
                      </div>
                    </div>

                    <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-800 mt-auto">
                       <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">Permission</span>
                       <span className="text-xs font-bold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-2.5 py-1 rounded-md border border-blue-100 dark:border-blue-900/30">
                         Perm: {queue.perm}
                       </span>
                    </div>
                  </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                 <div>
                    ...
                    <div className="relative">
                      <select className="w-full px-3 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all appearance-none cursor-pointer hover:bg-white dark:hover:bg-gray-750 hover:shadow-sm">
                    ...
                    >
                        {selectedBrokers.length === 0 ? (
                           ...
                           selectedBrokers.map(b => (
                             <span key={b} className="bg-blue-50 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded text-xs border border-blue-100 dark:border-blue-800 flex items-center font-medium">
                               {b}
                               <X 
            ...
            <div className="bg-white dark:bg-gray-900 p-5 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="relative">
                      <select className="w-full px-3 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all appearance-none cursor-pointer shadow-sm">
        ...
        >
          ...
          <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-white dark:bg-gray-900 z-10">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Real-time offset status for <span className="font-mono text-gray-700 dark:text-gray-300 font-medium">{topic?.name || 'OrderPlaced_TOPIC'}</span>
              </p>
            </div>
            <button 
              onClick={onClose}
          ...
          <div className="p-6 overflow-auto bg-gray-50/50 dark:bg-gray-950/50 flex-1 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               <div className="bg-white dark:bg-gray-900 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm flex items-center justify-between">
                  <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {mockData.map((row, i) => (
                <div key={i} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden flex flex-col">
                  
                  {/* Card Header */}
                  <div className="px-4 py-3 border-b border-gray-50 dark:border-gray-800 flex items-center justify-between bg-gray-50/30 dark:bg-gray-800/30">
                     <div className="flex items-center space-x-2">
                        <div className="w-6 h-6 rounded bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center text-xs font-bold text-gray-700 dark:text-gray-300 shadow-sm">
                           {row.queueId}
                        </div>
                        <span className="text-sm font-semibold text-gray-900 dark:text-white">{row.brokerName}</span>
                     </div>
                     <span className="text-[10px] font-mono text-gray-400 dark:text-gray-500 bg-white dark:bg-gray-800 px-1.5 py-0.5 rounded border border-gray-100 dark:border-gray-700">
                        ID: {row.queueId}
                     </span>
                  </div>
                  ...
                  {/* Footer */}
                  <div className="px-4 py-2 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-800 text-[10px] text-gray-400 dark:text-gray-500 flex items-center justify-between">
        ...
        >
          ...
          <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-white dark:bg-gray-900 z-10">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Manage consumer groups and view lag for <span className="font-mono text-gray-700 dark:text-gray-300 font-medium">{topic?.name}</span>
              </p>
            </div>
            <button 
              onClick={onClose}
          ...
          <div className="p-6 overflow-auto bg-gray-50/50 dark:bg-gray-950/50 space-y-6">
            {subscriptionGroups.map((group, idx) => (
              <div key={idx} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
                {/* Group Header */}
                <div className="px-6 py-4 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <tr key={dIdx} className="hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-colors group">
                          <td className="px-6 py-3">
                             <div className="flex items-center space-x-2">
                                ...
                                <span className="w-5 h-5 rounded bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-xs font-mono text-gray-600 dark:text-gray-400">{detail.queue}</span>
                             </div>
                          </td>
                          ...
                          <td className="px-6 py-3 text-right">
                             <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-bold bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 border border-red-100 dark:border-red-800">
                               {detail.diffTotal}
                             </span>
                          </td>
          ...
          <div className="p-6 space-y-5 bg-gray-50/50 dark:bg-gray-950/50">
            <div className="bg-white dark:bg-gray-900 p-5 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm space-y-4">
              ...
              <div className="grid grid-cols-[120px_1fr] items-center gap-4 pt-1">
                 <div className="col-start-2 flex items-center bg-gray-50 dark:bg-gray-800 px-3 py-2 rounded-lg border border-gray-100 dark:border-gray-700">
          ...
          <div className="p-6 space-y-5 bg-gray-50/50 dark:bg-gray-950/50">
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <select className="w-full px-3 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all appearance-none cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-750">
...
export const TopicView = () => {
  ...
  const topics = [
    ...
    { name: 'DefaultCluster', type: 'SYSTEM', operations: ['Status', 'Router', 'Consumer Manage', 'Topic Config', 'Send Message', 'Reset Consumer Offset', 'Skip Message Accumulate', 'Delete'] },
    { name: 'OrderPlaced_TOPIC', type: 'NORMAL', operations: ['Status', 'Router', 'Consumer Manage', 'Topic Config', 'Send Message', 'Reset Consumer Offset', 'Skip Message Accumulate', 'Delete'] },
    ...
    { name: 'benchmark', type: 'NORMAL', operations: ['Status', 'Router', 'Consumer Manage', 'Topic Config', 'Send Message', 'Reset Consumer Offset', 'Delete'] },
  ...
  const getActionIcon = (action: string) => {
    switch(action) {
      ...
      case 'Consumer Manage': return Users;
      case 'Topic Config': return Settings;
      case 'Send Message': return Send;
      case 'Reset Consumer Offset': return RotateCcw;
      case 'Skip Message Accumulate': return FastForward;
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      {/* Filter Toolbar */}
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-4 shadow-sm space-y-4 sticky top-0 z-10 backdrop-blur-xl bg-white/90 dark:bg-gray-900/90 transition-colors">
        ...
        <AnimatePresence mode="popLayout">
          {topics.map((topic, index) => (
            ...
            >
              ...
              <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br opacity-5 dark:opacity-10 rounded-bl-full pointer-events-none transition-opacity duration-300 group-hover:opacity-10 dark:group-hover:opacity-20 ${
                 ...
                 <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                    {topic.operations.map((op) => {
                      ...
                      return (
                        ...
                        >
                          <Icon className={`w-4 h-4 mb-1.5 transition-transform duration-200 group-hover/btn:scale-110 ${isDanger ? 'opacity-90' : 'opacity-70'}`} />
