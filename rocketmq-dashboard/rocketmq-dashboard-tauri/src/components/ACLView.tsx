...
export const ACLView = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                <div className="flex flex-wrap items-center gap-4">
                    <div className="flex items-center space-x-2 flex-1 min-w-[200px]">
                        ...
                        <select
                            className="flex-1 px-3 py-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-white">
                    ...
                    <button
                        className="px-6 py-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-sm font-medium rounded-lg hover:opacity-90 transition-opacity shadow-sm">
                        Confirm
                    </button>
                </div>
            </Card>
            ...
            {/* Main Content Area */}
            <div
                className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden min-h-[500px] flex flex-col">
                {/* Tabs */}
                            ...
                            <div className="p-6 space-y-5 overflow-y-auto">
                                <div className="space-y-1.5">
                                    ...
                                    <div className="flex gap-2">
                                        <select
                                            className="w-32 px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-950 focus:ring-2 focus:ring-blue-500 outline-none text-sm dark:text-white">
                                            <option>User</option>
                                            <option>Role</option>
                                        </select>
                                        <input
