...
impl MessageView {
    ...
    pub fn new() -> Self {
        ...
        let messages = vec![
            MessageData {
                msg_id: "C0A8017E00002A9F0000000000001A3F".to_owned(),
                topic: "TopicTest".to_owned(),
                tags: "tagA".to_owned(),
                keys: "key-123456".to_owned(),
                queue_id: 0,
                queue_offset: 1245,
                store_size: 256,
                born_timestamp: "2026-01-28 12:34:56".to_owned(),
                born_host: "192.168.192.1:12345".to_owned(),
                store_timestamp: "2026-01-28 12:34:57".to_owned(),
                store_host: "192.168.192.1:10911".to_owned(),
                msg_type: MessageType::Normal,
                icon_color: rgb(0x007AFF),
                icon_bg: rgb(0xE3F2FD),
            },
            MessageData {
                msg_id: "C0A8017E00002A9F0000000000001A40".to_owned(),
                topic: "TopicTest".to_owned(),
                tags: "tagB".to_owned(),
                keys: "key-789012".to_owned(),
                queue_id: 1,
                queue_offset: 1246,
                store_size: 320,
                born_timestamp: "2026-01-28 12:35:01".to_owned(),
                born_host: "192.168.192.2:54321".to_owned(),
                store_timestamp: "2026-01-28 12:35:02".to_owned(),
                store_host: "192.168.192.1:10911".to_owned(),
                msg_type: MessageType::Transaction,
                icon_color: rgb(0x34C759),
                icon_bg: rgb(0xE8F5E9),
            },
            MessageData {
                msg_id: "C0A8017E00002A9F0000000000001A41".to_owned(),
                topic: "TopicTest".to_owned(),
                tags: "tagC".to_owned(),
                keys: "key-345678".to_owned(),
                queue_id: 0,
                queue_offset: 1247,
                store_size: 180,
                born_timestamp: "2026-01-28 12:36:15".to_owned(),
                born_host: "192.168.192.3:98765".to_owned(),
                store_timestamp: "2026-01-28 12:36:16".to_owned(),
                store_host: "192.168.192.1:10911".to_owned(),
                msg_type: MessageType::Delay,
                icon_color: rgb(0xFF9500),
                icon_bg: rgb(0xFFF3E0),
            },
        ];
