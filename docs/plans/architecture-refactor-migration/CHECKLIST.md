...
M10/Phase 3 动态验收与签署、6 个 M12；R01～R08、R10～R17、R22～R24 已完成，当前剩余 12 个。该数字不替代 82 个顶层工作包口径；逐项 checklist
...
- [ ] PR-M11-12：完成 ArcMut、stable 与 SLO Phase 3 收口
  ...
  - [ ] M11-12bc115 及后续：完成 R09/R18 compatibility、真实动态证据与同一候选快照 Gate
