...
PR-M11-12 的内部子切片不重复计入 82 个顶层工作包。Issue #8547 的 M11-12bc67 子切片完成后，当前 ArcMut reviewed
baseline 为 137 identities / 493 occurrences，其中 production 为 62/159、test 为 61/294、compatibility
...
- [ ] PR-M11-12：完成 ArcMut、stable 与 SLO Phase 3 收口
  ...
  - [ ] M11-12bc68 及后续：完成 Local-Rocks/Store owner、Store WAL/其余 queue/timer/HA、compatibility 删除、stable/Miri/Loom/soak/SLO 与同一候选快照 Gate
