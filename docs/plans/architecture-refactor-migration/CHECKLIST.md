...
M10/Phase 3 动态验收与签署、6 个 M12；R01～R08、R10～R17、R22 已完成，当前剩余 14 个。该数字不替代 82 个顶层工作包口径；逐项 checklist
及每组精确 baseline 见 [`REMAINING-TASKS.md`](REMAINING-TASKS.md#执行层最小审查清单31-项)。

PR-M11-12 的内部子切片不重复计入 82 个顶层工作包。Issue #8645 的 M11-12bc112 候选完成后，当前 ArcMut reviewed
...
PR-M11-12 仍须完成 R09/R18、Miri/Loom 可用切片、soak/SLO fault、dashboard/runbook/rollback 证据；M10 固定硬件性能、五镜像动态验证、
...
- [ ] PR-M11-12：完成 ArcMut、stable 与 SLO Phase 3 收口
  ...
  - [ ] M11-12bc113 及后续：完成 R09/R18 compatibility、Miri/Loom、soak/SLO 与同一候选快照 Gate
