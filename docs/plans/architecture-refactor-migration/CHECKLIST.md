...
PR-M11-12 的内部子切片不重复计入 82 个顶层工作包。Issue #8631 的 M11-12bc105 子切片完成后，当前 ArcMut reviewed
...
- [ ] PR-M11-12：完成 ArcMut、stable 与 SLO Phase 3 收口
  ...
  - [ ] M11-12bc106 及后续：提取 read/lifecycle capability 并移除 R01 私有 legacy Store owner，再处理其余 Store/runtime-foundation test caller、公开 compatibility 删除、stable/Miri/Loom/soak/SLO 与同一候选快照 Gate
