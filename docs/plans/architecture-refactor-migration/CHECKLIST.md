...
M10/Phase 3 动态验收与签署、6 个 M12；R01～R08、R10～R17、R22～R23 已完成，当前剩余 13 个。该数字不替代 82 个顶层工作包口径；逐项 checklist
及每组精确 baseline 见 [`REMAINING-TASKS.md`](REMAINING-TASKS.md#执行层最小审查清单31-项)。

PR-M11-12 的内部子切片不重复计入 82 个顶层工作包。Issue #8647 的 M11-12bc113 候选完成后，当前 ArcMut reviewed
...
结论是 ArcMut facade 不得长期保留，R18 仍须等待兼容批准窗口。PR-M11-12 还须完成 R09/R18、soak/SLO fault、
dashboard/runbook/rollback 证据；M10 固定硬件性能、五镜像动态验证、
...
- [ ] PR-M11-12：完成 ArcMut、stable 与 SLO Phase 3 收口
  ...
  - [ ] M11-12bc114 及后续：完成 R09/R18 compatibility、soak/SLO 与同一候选快照 Gate
