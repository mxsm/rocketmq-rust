...
PR-M11-12 的内部子切片不重复计入 82 个顶层工作包。Issue #8641 的 M11-12bc110 候选完成后，当前 ArcMut reviewed
...
M11-12bc110 已将 nightly feature 属性从 8 个降至 4 个，并以
`scripts/stable_surface_guard.py` 冻结精确 baseline；剩余 Runtime 2 个和 R18 兼容面 2 个未清零前，
stable target 模式保持 fail closed。
...
- [ ] PR-M11-12：完成 ArcMut、stable 与 SLO Phase 3 收口
  ...
  - [ ] M11-12bc111 及后续：完成 R09/R18 compatibility、Runtime stable surface、Miri/Loom、soak/SLO 与同一候选快照 Gate
