...
|---|---:|---:|---:|---:|
| PR 级工作包 | 43 | 0 | 39 未开始；合计 39 尚未完成 | 82 |
...
剩余 39 个未开始工作包分布：M07 为 4 个、M08 为 6 个、M09 为 6 个、M10 为 5 个、M11 为 12 个、
M12 为 6 个。PR-M07-03 已完成 NameServer RouteLookup 反转；M07 继续进行，当前下一工作包为 PR-M07-04。
