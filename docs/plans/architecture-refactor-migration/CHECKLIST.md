...
PR-M11-12 的内部子切片不重复计入 82 个顶层工作包。Issue #8501 的 M11-12bc45 子切片完成后，当前 ArcMut reviewed
baseline 为 279 identities / 829 occurrences，其中 production 为 135/369、test 为 130/420、compatibility
...
- [ ] PR-M11-12：完成 ArcMut、stable 与 SLO Phase 3 收口
  ...
  - [ ] M11-12bc46 及后续：Broker aggregate/leaf、Store WAL/其余 queue/timer/HA、compatibility 删除、stable/Miri/Loom/soak/SLO 与同一候选快照 Gate 仍待完成
