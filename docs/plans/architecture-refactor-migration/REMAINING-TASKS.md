...
> 盘点日期：2026-07-23
> 代码基线：Issue #8607 / M11-12bc95 完成后
...
Issue #8607 后 reviewed ArcMut baseline 为 55 identities / 210 occurrences：production 13/24、test
28/146、compatibility 14/40。production 全部分布在 Broker 与 Store。
...
> 本清单给出当前可执行下界。`identity / occurrence` 来自 Issue #8607 后通过
