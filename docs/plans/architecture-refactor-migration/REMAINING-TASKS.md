...
> 盘点日期：2026-07-23
> 代码基线：Issue #8639 / M11-12bc109 完成后
...
Issue #8639 / M11-12bc109 后 reviewed ArcMut baseline 为 22 identities / 60 occurrences：production
...
6. compatibility/stable：production Store `WeakArcMut` 与活跃 test/bench caller 已清零；按 next-major/HUMAN 窗口处理公开 facade 及其自测夹具，并替换 `sync_unsafe_cell`、`async_fn_traits`、`unboxed_closures` 等 nightly surface。
