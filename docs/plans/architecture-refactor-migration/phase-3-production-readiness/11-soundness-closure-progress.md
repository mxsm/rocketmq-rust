...
该目标尚未完成。本文件记录 M11-12a～d 子切片的真实下降，不把子切片计为第 76 个工作包，也不刷新
...
2. Controller remoting-client owner 与 NameServer v1 tables/runtime 安全 owner；Manager/heartbeat/Raft shell 已完成。
