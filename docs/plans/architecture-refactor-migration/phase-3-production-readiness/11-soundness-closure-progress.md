...
test/compatibility、7 个 M10/Phase 3 动态验收与签署、6 个 M12；R01～R08、R10～R17、R22 已完成，当前剩余
14 个，正式进度仍为 75/82。
...
4. nightly feature 属性已从 8 个降至 0 个，baseline/target guard 和完整 stable workspace matrix 均通过，
   R22 已关闭；继续按批准窗口删除 R18 compatibility facade，并执行 Miri/Loom 可用切片、soak/SLO fault、
   dashboard/runbook、动态 Kind/K3d/container、M10 固定硬件和 Human Gate。
