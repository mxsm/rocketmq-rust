...
| Controller | `rocketmq-controller` / `rocketmq-controller-rust` | `controller` | `/etc/rocketmq/controller.toml` | `/var/lib/rocketmq/controller` | 60109 | `--config-file ...` |
...
MessageStore 使用 `/var/lib/rocketmq/broker`，NameServer 使用 9876，Controller 使用 60109/Memory smoke store，
