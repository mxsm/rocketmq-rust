...
#[header(
    type_id = "rocketmq_protocol::protocol::header::add_broker_request_header::AddBrokerRequestHeader",
    java_class = "org.apache.rocketmq.remoting.protocol.header.AddBrokerRequestHeader"
)]
