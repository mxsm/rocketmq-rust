...
#[header(
    type_id = "rocketmq_protocol::protocol::header::create_user_request_header::CreateUserRequestHeader",
    java_class = "org.apache.rocketmq.remoting.protocol.header.CreateUserRequestHeader"
)]
