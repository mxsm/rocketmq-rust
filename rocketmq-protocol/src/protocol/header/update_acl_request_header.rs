...
#[header(
    type_id = "rocketmq_protocol::protocol::header::update_acl_request_header::UpdateAclRequestHeader",
    java_class = "org.apache.rocketmq.remoting.protocol.header.UpdateAclRequestHeader"
)]
