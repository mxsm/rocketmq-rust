...
#[header(
    type_id = "rocketmq_protocol::protocol::header::delete_user_request_header::DeleteUserRequestHeader",
    java_class = "org.apache.rocketmq.remoting.protocol.header.DeleteUserRequestHeader"
)]
