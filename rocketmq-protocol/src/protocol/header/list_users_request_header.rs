...
#[header(
    type_id = "rocketmq_protocol::protocol::header::list_users_request_header::ListUsersRequestHeader",
    java_class = "org.apache.rocketmq.remoting.protocol.header.ListUsersRequestHeader"
)]
