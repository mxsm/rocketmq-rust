...
#[header(
    type_id = "rocketmq_protocol::protocol::header::get_max_offset_response_header::GetMaxOffsetResponseHeader",
    java_class = "org.apache.rocketmq.remoting.protocol.header.GetMaxOffsetResponseHeader"
)]
