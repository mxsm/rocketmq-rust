...
#[header(
    type_id = "rocketmq_protocol::protocol::header::remove_broker_request_header::RemoveBrokerRequestHeader",
    java_class = "org.apache.rocketmq.remoting.protocol.header.RemoveBrokerRequestHeader"
)]
