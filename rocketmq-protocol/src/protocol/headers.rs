...
//! ## Import by category
//! ```rust
//! use rocketmq_protocol::protocol::headers::message::SendMessageRequestHeader;
//! use rocketmq_protocol::protocol::headers::namesrv::RegisterBrokerRequestHeader;
//! use rocketmq_protocol::protocol::headers::namesrv::UnRegisterBrokerRequestHeader;
//! ```
//!
//! ## Import most common types directly
//! ```rust
//! use rocketmq_protocol::protocol::headers::PullMessageRequestHeader;
//! use rocketmq_protocol::protocol::headers::SendMessageRequestHeader;
//! ```
...
// These are available as: rocketmq_protocol::protocol::headers::<TypeName>
