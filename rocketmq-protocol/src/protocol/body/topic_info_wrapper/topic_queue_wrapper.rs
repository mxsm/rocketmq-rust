...
impl TopicQueueMappingSerializeWrapper {
    pub fn topic_queue_mapping_info_map(&self) -> Option<&HashMap<CheetahString, TopicQueueMappingDetail>> {
        self.topic_queue_mapping_info_map.as_ref()
    }

    pub fn take_topic_queue_mapping_info_map(&mut self) -> Option<HashMap<CheetahString, TopicQueueMappingDetail>> {
...
mod tests {
    ...
    fn create_test_map() -> HashMap<CheetahString, TopicQueueMappingDetail> {
        let mut map = HashMap::new();
        let detail = TopicQueueMappingDetail::default();
        map.insert(CheetahString::from("test_topic"), detail);
        map
    }
