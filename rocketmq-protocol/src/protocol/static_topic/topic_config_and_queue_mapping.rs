...
impl TopicConfigAndQueueMapping {
    pub fn new(topic_config: TopicConfig, topic_queue_mapping_detail: Option<TopicQueueMappingDetail>) -> Self {
        Self {
            topic_config,
    ...
    pub fn set_topic_queue_mapping_detail(&mut self, topic_queue_mapping_detail: Option<TopicQueueMappingDetail>) {
...
mod tests {
    ...
    fn topic_config_and_queue_mapping_serde() {
        ...
        let mapping = TopicConfigAndQueueMapping::new(topic_config, Some(mapping_detail));
