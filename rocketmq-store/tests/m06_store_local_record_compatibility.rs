...
fn legacy_constant_and_blank_paths_preserve_identity_and_signatures() {
    ...
    assert_eq!(
        record::MESSAGE_MAGIC_CODE,
        rocketmq_protocol::protocol::body::message_codec::MESSAGE_MAGIC_CODE
    );
    assert_eq!(
        record::MESSAGE_MAGIC_CODE_V2,
        rocketmq_model::common::message::MESSAGE_MAGIC_CODE_V2
    );
    assert_eq!(
        record::MESSAGE_MAGIC_CODE_V2,
        rocketmq_protocol::protocol::body::message_codec::MESSAGE_MAGIC_CODE_V2
    );
