...
use rocketmq_store::CommitLogDispatcherBuildRocksDbTrans;
use rocketmq_store::ConsumeQueueBatchEntry;
use rocketmq_store::ConsumeQueueBatchWriteRequest;
use rocketmq_store::ConsumeQueueKey;
use rocketmq_store::ConsumeQueueOffsetBoundary;
use rocketmq_store::ConsumeQueueOffsetKey;
use rocketmq_store::ConsumeQueueOffsetUpdate;
use rocketmq_store::ConsumeQueueOffsetValue;
use rocketmq_store::ConsumeQueueValue;
use rocketmq_store::DispatchRequest;
use rocketmq_store::IndexRocksDbKey;
use rocketmq_store::IndexRocksDbRecord;
use rocketmq_store::IndexRocksDbValue;
...
use rocketmq_store::RocksDbCompactionStyle;
use rocketmq_store::RocksDbCompressionType;
use rocketmq_store::RocksDbConfig;
use rocketmq_store::RocksDbConsumeQueueBatchWriter;
use rocketmq_store::RocksDbConsumeQueueGroupCommitConfig;
use rocketmq_store::RocksDbConsumeQueueGroupCommitService;
use rocketmq_store::RocksDbConsumeQueueStore;
use rocketmq_store::RocksDbDataBlockIndexType;
use rocketmq_store::RocksDbIndexBuildConfig;
use rocketmq_store::RocksDbIndexBuildService;
use rocketmq_store::RocksDbMaintenanceConfig;
use rocketmq_store::RocksDbMaintenanceService;
use rocketmq_store::RocksDbOptionsFactory;
use rocketmq_store::RocksDbRangeScanOptions;
use rocketmq_store::RocksDbRuntimeScope;
use rocketmq_store::RocksDbScanOptions;
use rocketmq_store::RocksDbStore;
use rocketmq_store::RocksDbStoreState;
use rocketmq_store::RocksDbTimerBuildConfig;
use rocketmq_store::RocksDbTimerBuildService;
...
use rocketmq_store::TimerRocksDbBuildEntry;
use rocketmq_store::TimerRocksDbKey;
use rocketmq_store::TimerRocksDbRecord;
use rocketmq_store::TimerRocksDbValue;
use rocketmq_store::TransRocksDbKey;
use rocketmq_store::TransRocksDbRecord;
use rocketmq_store::TransRocksDbValue;
use rocketmq_store::PROPERTY_TIMER_ROLL_LABEL;
use rocketmq_store::PROPERTY_TRANS_OFFSET;
use rocketmq_store::RMQ_SYS_ROCKSDB_TRANS_HALF_TOPIC;
use rocketmq_store::RMQ_SYS_ROCKSDB_TRANS_OP_HALF_TOPIC;
...
fn rocksdb_service_context(name: &'static str) -> rocketmq_runtime::ChildServiceContext {
    ...
    OWNER
        .get_or_init(|| {
            rocketmq_runtime::RuntimeOwner::new().expect("RocksDB integration-test runtime owner should start")
        })
        .root_context()
        .component(name)
}
