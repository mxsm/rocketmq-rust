...
//! Explicit Store test and benchmark fixtures.
//!
...
pub const DEFAULT_IO_URING_FLUSH_BENCHMARK_WORKLOAD: IoUringFlushBenchmarkWorkload = IoUringFlushBenchmarkWorkload {
    ...
    let scenarios = scenario_specs
        ...
        .map(
            |(
                ...
                measured_benefit_percent,
                high_variance,
                default_enabled: phase5_platform_optimization_default_enabled(measured_benefit_percent, high_variance),
                conclusion,
                not_applicable_reason,
            },
        )
...
async fn wait_for_store_blocking_idle(runtime_scope: &crate::runtime::StoreRuntimeScope) -> BlockingExecutorSnapshot {
