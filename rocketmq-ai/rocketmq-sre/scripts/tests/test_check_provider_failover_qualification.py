...
def valid_manifest() -> dict:
    return {
        ...
        "repository_evidence": {
            "live_test_path": "rocketmq-ai/rocketmq-sre/crates/rocketmq-sre-control-plane/src/models/service/live_provider_failover.rs",
            "live_test": "transient_primary_falls_back_to_live_deepseek_and_failures_remain_rules_only",
            "runner": "rocketmq-ai/rocketmq-sre/scripts/provider-failover-qualification.ps1",
            "checker": "rocketmq-ai/rocketmq-sre/scripts/check_provider_failover_qualification.py",
        },
        "live_report": {
