...
pub use capability::ConnectorCapabilityOutcome;
pub use capability::ConnectorCapabilityRejection;
...
pub use error::ConnectorAdmissionOutcome;
pub use error::ConnectorAdmissionRejection;
pub use error::ConnectorError;
pub use error::ConnectorErrorView;
pub use error::ConnectorFailure;
