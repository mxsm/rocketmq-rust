...
.\rocketmq-ai\rocketmq-sre\scripts\kind.ps1 -Action Smoke
.\rocketmq-ai\rocketmq-sre\scripts\kind.ps1 -Action Ports
.\rocketmq-ai\rocketmq-sre\scripts\kind.ps1 -Action Down
```
...
.\rocketmq-ai\rocketmq-sre\scripts\phase00-runtime-diagnostics-smoke.ps1
```
...
```powershell
.\rocketmq-ai\rocketmq-sre\scripts\phase01-kind-smoke.ps1
```
...
kubectl kustomize .\rocketmq-ai\rocketmq-sre\deploy\kind > $null
helm template rocketmq .\distribution\helm\rocketmq-rust `
  ...
  -f .\rocketmq-ai\rocketmq-sre\deploy\kind\helm-values.yaml > $null
```
