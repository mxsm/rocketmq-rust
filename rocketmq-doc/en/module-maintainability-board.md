...
This is an archived architecture-review snapshot. The size and baseline gate was retired
on 2026-09-08. Rankings and paths describe that snapshot, not current requirements.
Use the repository engineering guidance for current module reviews; line counts and
score changes do not block development.
