...
const OPERATION_ANNOTATION: &str = "rocketmqrust.com/sre-restart-operation";
const LAST_OPERATION_ANNOTATION: &str = "rocketmqrust.com/sre-restart-last-operation";
const EXECUTION_ANNOTATION: &str = "rocketmqrust.com/sre-restart-execution";
const PLAN_STEP_ANNOTATION: &str = "rocketmqrust.com/sre-restart-plan-step";
const ORIGINAL_POD_ANNOTATION: &str = "rocketmqrust.com/sre-restart-original-pod";
const ORIGINAL_UID_ANNOTATION: &str = "rocketmqrust.com/sre-restart-original-uid";
const STARTED_AT_ANNOTATION: &str = "rocketmqrust.com/sre-restart-started-at";
