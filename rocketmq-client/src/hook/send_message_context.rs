 ...
 */
 ...
 pub struct SendMessageContext<'a> {
     ...
     pub message: Option<&'a mut Message>,
     ...
     pub exception: Option<Arc<Box<dyn Error + Send>>>,
     pub mq_trace_context: Option<Arc<Box<dyn std::any::Any + Send>>>,
     pub props: HashMap<String, String>,
     pub producer: Option<&'a mut DefaultMQProducerImpl>,
