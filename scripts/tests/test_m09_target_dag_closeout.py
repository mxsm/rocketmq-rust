...
class TargetDagCloseoutTests(unittest.TestCase):
    def test_target_guard_closes_unapproved_edges_and_reports_debt_separately(self) -> None:
        ...
        self.assertIn("TARGET_COMPATIBILITY_LEDGER active_edges=49 entries=49", result.stdout)
    ...
    def test_temporary_exceptions_are_empty_and_removal_windows_are_current(self) -> None:
        ...
        self.assertEqual(49, len(ledger))
        self.assertEqual(49, len(identities))
        self.assertEqual(
            Counter({"R1": 29, "M09-02": 11, "next-major": 4, "M09-04": 3, "long-term": 2}),
