...
run_route H03-DRAFT-NO-REMOTE "$worker" "$context" "$event_root" "$python_command" scripts/no_remote_publication_guard.py --candidate-manifest "$candidate" --phase 6 --context-root "$context_root" --event-root "$event_root" --handoff "$staging" --output "$source_import/evidence/H03-DRAFT-NO-REMOTE.json"
...
run_route H05-FINAL-NO-REMOTE "$worker" "$context" "$event_root" "$python_command" scripts/no_remote_publication_guard.py --candidate-manifest "$candidate" --phase 6 --context-root "$context_root" --event-root "$event_root" --handoff "$final" --output "$source_import/evidence/H05-FINAL-NO-REMOTE.json"
