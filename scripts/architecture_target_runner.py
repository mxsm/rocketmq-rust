...
MEASUREMENT_COMMANDS: dict[tuple[str, str], tuple[str, ...]] = {
    ...
    ("proxy-mixed-execution", "same-and-distinct-keys"): (
        "cargo",
        "run",
        "--release",
        "--quiet",
        ...
        "bench-support",
        "--example",
        "architecture_proxy_performance_collector",
        "--",
        "proxy-mixed-execution",
        "same-and-distinct-keys",
    ),
    ("transaction-queue-io", "queues-8"): (
        "cargo",
        "run",
        "--release",
        "--quiet",
        ...
        "rocketmq-broker",
        "--example",
        "architecture_transaction_performance_collector",
        "--",
