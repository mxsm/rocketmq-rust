...
impl BrokerConfig {
    ...
    pub fn store_runtime_config(&self) -> rocketmq_store::StoreRuntimeConfig {
        rocketmq_store::StoreRuntimeConfig {
            ...
            duplication_enable: self.duplication_enable,
            enable_slave_acting_master: self.enable_slave_acting_master,
            auto_delete_unused_stats: self.auto_delete_unused_stats,
            recover_concurrently: self.recover_concurrently,
            long_polling_enable: self.long_polling_enable,
            enable_detail_stat: self.enable_detail_stat,
        }
    }
...
mod tests {
    ...
    #[test]
    fn broker_properties_exclude_legacy_observability_keys_but_preserve_trace_on() {
        ...
        for removed in [
            ...
            assert!(
                ...
                "legacy key must be removed: {removed}"
            );
        }
        assert_eq!(properties.get("traceOn").map(CheetahString::as_str), Some("true"));
    }
