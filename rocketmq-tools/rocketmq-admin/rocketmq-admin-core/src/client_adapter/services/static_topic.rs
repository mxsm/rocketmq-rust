...
use rocketmq_client_rust::admin_adapter_compat::remoting::protocol::static_topic::topic_remapping_detail_wrapper;
use rocketmq_client_rust::admin_adapter_compat::remoting::protocol::static_topic::topic_remapping_detail_wrapper::TopicRemappingDetailWrapper;
...
impl StaticTopicService {
    ...
    pub async fn update_static_topic_from_mapping_by_request_with_credentials(
    ...
    pub(crate) async fn update_static_topic_from_mapping_with_admin(
        admin: &DefaultMQAdminExt,
        request: &StaticTopicMappingFileRequest,
        wrapper: TopicRemappingDetailWrapper,
    ) -> RocketMQResult<()> {
    ...
    pub async fn remapping_static_topic_from_mapping_by_request_with_credentials(
        request: StaticTopicMappingFileRequest,
    ...
    pub(crate) async fn remapping_static_topic_from_mapping_with_admin(
        admin: &DefaultMQAdminExt,
        request: &StaticTopicMappingFileRequest,
