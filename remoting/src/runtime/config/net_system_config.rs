...
pub const SOCKET_SNDBUF_SIZE: &str = "com.rocketmq.remoting.socket.sndbuf.size";
pub const SOCKET_RCVBUF_SIZE: &str = "com.rocketmq.remoting.socket.rcvbuf.size";
pub const SOCKET_BACKLOG: &str = "com.rocketmq.remoting.socket.backlog";
pub const CLIENT_ASYNC_SEMAPHORE_VALUE: &str = "com.rocketmq.remoting.clientAsyncSemaphoreValue";
pub const CLIENT_ONEWAY_SEMAPHORE_VALUE: &str = "com.rocketmq.remoting.clientOnewaySemaphoreValue";
pub const CLIENT_WORKER_SIZE: &str = "com.rocketmq.remoting.client.worker.size";
pub const CLIENT_CONNECT_TIMEOUT: &str = "com.rocketmq.remoting.client.connect.timeout";
...
pub const WRITE_BUFFER_LOW_WATER_MARK: &str = "com.rocketmq.remoting.write.buffer.low.water.mark";
