...
use crate::key::ConsumeQueueOffsetKey;
use crate::store::KeyValueStore;
use crate::store::RocksDbStore;
use crate::value::ConsumeQueueOffsetValue;
use crate::value::ConsumeQueueValue;
use crate::value::MaxPhysicalOffsetCheckpointValue;

mod group_commit;

pub use group_commit::RocksDbConsumeQueueGroupCommitConfig;
pub use group_commit::RocksDbConsumeQueueGroupCommitService;

pub trait RocksDbConsumeQueueDispatch {
    fn topic(&self) -> &str;
...
impl RocksDbConsumeQueueStore {
    ...
    pub fn downgrade_store(&self) -> Weak<RocksDbStore> {
        ...
        R: RocksDbConsumeQueueDispatch,
    {
        ...
        for request in requests {
            ...
            entries.push(ConsumeQueueBatchEntry {
                ...
                body_size: request.message_size(),
