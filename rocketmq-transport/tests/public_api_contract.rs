...
fn validate_public_api_v2_boundary(boundary: &PublicBoundary) -> Result<(), String> {
    ...
    let expected_uses = [
        ...
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredAdmissionAcquireError".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredAdmissionAcquireErrorKind".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredAdmissionConfigError".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredAdmissionConfigErrorKind".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
        ...
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredCancellationReason".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
        ...
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredExpiry".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredExpiryBatch".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredExpiryBatchStats".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredExpiryError".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredExpiryErrorKind".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredExpiryKind".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredExpiryMargins".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredId".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredParts".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
        ...
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredRegistry".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredRegistryError".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredRegistryErrorKind".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredRegistryShutdownOutcome".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredRegistryShutdownStats".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredRequest".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
        ...
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredRetainedSizeParts".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredTerminalReason".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::DeferredWaitLimits".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
        ...
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::EmbeddedDispatchError".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::EmbeddedDispatchErrorKind".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
            use_tree: "crate::dispatch::EmbeddedDispatchOutcome".to_owned(),
        },
        PublicUse {
            module_path: String::new(),
