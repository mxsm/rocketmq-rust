...
4. **Update both languages.** Keep page IDs, commands, configuration keys, units and diagram semantics aligned. Next describes the current development documentation; do not silently relabel it as a released version.
