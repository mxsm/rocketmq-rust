...
const generateOrbs = (count: number): Orb[] => {
  const colors = [
    'radial-gradient(circle, rgba(37, 99, 235, 0.5) 0%, rgba(37, 99, 235, 0) 70%)',
    'radial-gradient(circle, rgba(0, 191, 165, 0.4) 0%, rgba(0, 191, 165, 0) 70%)',
    'radial-gradient(circle, rgba(76, 175, 80, 0.4) 0%, rgba(76, 175, 80, 0) 70%)',
    'radial-gradient(circle, rgba(0, 188, 212, 0.4) 0%, rgba(0, 188, 212, 0) 70%)',
