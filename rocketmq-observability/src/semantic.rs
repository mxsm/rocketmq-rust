...
pub mod metrics {
    ...
    pub const NAMESRV_REQUESTS_TOTAL: &str = "rocketmq_namesrv_requests_total";
    pub const NAMESRV_REQUEST_HANDLER_LATENCY: &str = "rocketmq_namesrv_request_handler_latency";
    pub const NAMESRV_RESPONSE_BYTES: &str = "rocketmq_namesrv_response_bytes";
    pub const NAMESRV_REGISTRATION_BODY_BYTES: &str = "rocketmq_namesrv_registration_body_bytes";
    pub const NAMESRV_REGISTRATION_DECODE_LATENCY: &str = "rocketmq_namesrv_registration_decode_latency";
    pub const NAMESRV_MUTATION_LATENCY: &str = "rocketmq_namesrv_mutation_latency";
    pub const NAMESRV_SNAPSHOT_REBUILDS_TOTAL: &str = "rocketmq_namesrv_snapshot_rebuilds_total";
    pub const NAMESRV_EXPIRY_EVENTS_TOTAL: &str = "rocketmq_namesrv_expiry_events_total";
    pub const NAMESRV_UNREGISTRATION_OLDEST_AGE: &str = "rocketmq_namesrv_unregistration_oldest_age";
    pub const NAMESRV_KV_GENERATION: &str = "rocketmq_namesrv_kv_generation";
    pub const NAMESRV_KV_QUEUE_DEPTH: &str = "rocketmq_namesrv_kv_queue_depth";
    pub const NAMESRV_KV_QUEUE_BYTES: &str = "rocketmq_namesrv_kv_queue_bytes";
    pub const NAMESRV_KV_PERSIST_LATENCY: &str = "rocketmq_namesrv_kv_persist_latency";
    pub const NAMESRV_KV_BATCH_SIZE: &str = "rocketmq_namesrv_kv_batch_size";
    pub const NAMESRV_KV_EVENTS_TOTAL: &str = "rocketmq_namesrv_kv_events_total";
    pub const NAMESRV_SECURITY_EVENTS_TOTAL: &str = "rocketmq_namesrv_security_events_total";
    pub const NAMESRV_CONNECTION_EVENTS_TOTAL: &str = "rocketmq_namesrv_connection_events_total";
    pub const NAMESRV_ACTIVE_CONNECTIONS: &str = "rocketmq_namesrv_active_connections";
